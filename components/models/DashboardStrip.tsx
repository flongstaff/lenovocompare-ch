...
export const DashboardStrip = ({
  ...
  return (
    <div id="scores" className="border-carbon-600/60 grid scroll-mt-14 grid-cols-1 gap-4 border-b pb-6 md:grid-cols-3">
      {/* Scores card */}
                        ...
                        className={`px-1 py-0.5 font-mono text-[9px] uppercase tracking-wider ${
                          p.priceType === "sale"
                            ...
                            : p.priceType === "msrp"
                              ...
                              : p.priceType === "used"
                                ? "carbon-verdict-fair"
                                : "bg-carbon-700/30 border-carbon-600 text-carbon-300"
                        }`}
                      >
                        {p.priceType}
                      </span>
