...
- PostToolUse hooks may make large autonomous refactors (e.g., replacing framer-motion with CSS animations, rewriting recharts components as pure SVG) — review `git diff` before committing to understand what hooks changed vs what you changed
