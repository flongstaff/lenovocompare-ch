...
export const modelEditorial: Record<string, EditorialOverlay> = {
  ...
  "ideapad-pro-5-14-gen8-amd": {
    editorialNotes:
      "The 2023 Gen 8 AMD delivered excellent value for creators. The Ryzen 7 7840HS with Zen 4 and a 2.8K OLED display brought strong performance in a slim consumer chassis, making the IdeaPad Pro 5 14 a compelling choice in its price bracket.",
    knownIssues:
