...
export const modelBenchmarks: Record<string, ModelBenchmarks> = {
  ...
  // === ThinkPad X13 Gen 1 Intel (2020) ===
  "x13-gen1-intel": {
    thermals: { keyboardMaxC: 42.0, undersideMaxC: 45.0 },
    fanNoise: 38.0,
    battery: { officeHours: 8.0, videoHours: 10.0 },
    ssdSpeed: { seqReadMBs: 3400, seqWriteMBs: 2500 },
  ...
  "x13-gen3-intel": {
    ...
    fanNoise: 38.0,
    battery: { officeHours: 9.0, videoHours: 11.0 },
    ssdSpeed: { seqReadMBs: 5000, seqWriteMBs: 3500 },
    displayBrightness: 400,
    weightWithChargerGrams: 1590,
    sources: ["community"],
  },
  ...
  "x13-gen4-amd": {
    ...
    fanNoise: 36.0,
    battery: { officeHours: 10.0, videoHours: 12.0 },
    ssdSpeed: { seqReadMBs: 6500, seqWriteMBs: 5000 },
    displayBrightness: 400,
    weightWithChargerGrams: 1590,
    sources: ["community"],
  },
  // === ThinkPad X13s Gen 1 (2022, fanless ARM) ===
  "x13s-gen1": {
    thermals: { keyboardMaxC: 34.0, undersideMaxC: 37.0 },
    fanNoise: 0,
    battery: { officeHours: 14.0, videoHours: 18.0 },
    ssdSpeed: { seqReadMBs: 3500, seqWriteMBs: 2500 },
    displayBrightness: 400,
    weightWithChargerGrams: 1360,
    sources: ["community"],
  },
  ...
  "yoga-7-14ial7": {
    thermals: { keyboardMaxC: 40.0, undersideMaxC: 44.0 },
    fanNoise: 36.0,
    battery: { officeHours: 8.0, videoHours: 10.0 },
    ssdSpeed: { seqReadMBs: 5000, seqWriteMBs: 3500 },
    displayBrightness: 350,
  ...
  "yoga-7-16iah7": {
    thermals: { keyboardMaxC: 43.0, undersideMaxC: 47.0 },
    fanNoise: 40.0,
    battery: { officeHours: 7.0, videoHours: 9.0 },
    ssdSpeed: { seqReadMBs: 5000, seqWriteMBs: 3500 },
    displayBrightness: 400,
    weightWithChargerGrams: 2410,
    sources: ["community"],
  },
  "yoga-7-2in1-14ahp9": {
    thermals: { keyboardMaxC: 39.0, undersideMaxC: 42.0 },
  ...
  "yoga-9-2in1-14imh9": {
    ...
    fanNoise: 35.0,
    battery: { officeHours: 9.0, videoHours: 11.0 },
    ssdSpeed: { seqReadMBs: 6800, seqWriteMBs: 5500 },
    displayBrightness: 500,
    weightWithChargerGrams: 1840,
    sources: ["community"],
  },
  "yoga-slim-6-14iap8": {
    thermals: { keyboardMaxC: 38.0, undersideMaxC: 41.0 },
  ...
  "yoga-slim-7x-14are9": {
    thermals: { keyboardMaxC: 35.0, undersideMaxC: 38.0 },
    fanNoise: 30.0,
    battery: { officeHours: 14.0, videoHours: 18.0 },
    ssdSpeed: { seqReadMBs: 6000, seqWriteMBs: 4500 },
    displayBrightness: 400,
    weightWithChargerGrams: 1680,
    sources: ["community"],
  },
